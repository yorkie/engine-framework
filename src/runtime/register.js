...
// https://github.com/fireball-x/engine-framework/issues/1
 ...
 */
Fire.registerNodeType = function (nodeType, nodeWrapper) {
 ...
 * @method getNodeWrapper
 * @param {object|function} nodeOrNodeType
 * @return {NodeWrapper|undefined}
 */
Fire.getWrapperType = function (nodeOrNodeType) {
